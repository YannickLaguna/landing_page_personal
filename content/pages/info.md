...
sections:
  - elementId: ''
    ...
    text: >-
      ...
      Hi! I'm Yannick, born in the Canary Islands and curious by nature. My specialty is economics, with a clear focus
      on business and the private sector. I am passionate about understanding how organizations and markets work, which
      is why I have focused my training and experience in this area.


      I enjoy working across disciplines, collaborating with people from different fields and learning from each
      perspective. I firmly believe that learning never ends and that every project is an opportunity to grow, both
  ...
  - type: TextSection
    ...
    subtitle: 'Contact:'
    colors: colors-f
    text: '[thisismyemail.@myemail.me](mailto:thisismyemail.@myemail.me) '
  - type: DividerSection
    styles:
      self:
        width: wide
